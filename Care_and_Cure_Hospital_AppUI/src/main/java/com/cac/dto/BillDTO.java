...
public class BillDTO{
    ...
    private String paymentStatus; // From PaymentEntity
    private AppointmentDTO appObj;
	...
	public AppointmentDTO getAppObj() {
		return appObj;
	}
	public void setAppObj(AppointmentDTO appObj) {
		this.appObj = appObj;
	}
