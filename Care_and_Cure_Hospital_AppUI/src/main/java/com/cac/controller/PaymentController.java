...
import com.cac.dto.PaymentViewTransactionDTO;
...
public class PaymentController
{
	...
	public String addTransaction(@ModelAttribute Payment payment, RedirectAttributes redirectAttributes) {
	    ResponseEntity<Payment> response = restTemplate.postForEntity(BASE_URL + "/addTransaction", payment, Payment.class);
    ...
    public String generatePaymentHistoryReport(
        ...
        try {
            ...
            ResponseEntity<List<Payment>> response = restTemplate.exchange(
                    apiUrl, HttpMethod.GET, null, new ParameterizedTypeReference<List<Payment>>() {}
            );


            List<Payment> transactions = response.getBody();
	...
	@GetMapping("/razorpayPaymentFormPD")
	public String showRazorpayPaymentPagePD(){	
	    return "razorpayPaymentPD"; 
	}
